...
| styleSkipBtn                                                                                           | `TextStyle`               | White color                                       | Style for text at SKIP button                                                                       |
...
| stylePrevBtn                                                                                           | `TextStyle`               | White color                                       | Style for text at PREV button                                                                       |
...
| showPrevBtn                                                                                            | `bool`                    | false                                             | Show or hide PREV button                                                                            |
...
| styleDoneBtn                                                                                           | `TextStyle`               | White color                                       | Style for text at DONE button                                                                       |
